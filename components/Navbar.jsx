...
const resources = [
  ...
  { name: 'Knowledge Blog', 
  description: 'Understand how we take your privacy seriously.', href: '#', 
...
const recentPosts = [
  { id: 1, 
    name: 'Boost your developer knowledge', 
    href: '#' 
  },
  { id: 2, 
    name: 'How to use a search engine to find answers fast', 
    href: '#' 
  },
  { id: 3, 
    name: '5 tips to improve your code', 
    href: '#' 
  },
]
        ...
        <div className="flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
          <div className="flex items-center justify-start lg:w-0 lg:flex-1">
            <a href="/">
              ...
              <img
                className="h-12 w-auto sm:h-12 m-2"
                src="/img/logo.png"
                alt=""
              /> 
            </a>
          ...
          <Popover.Group as="nav" className="hidden md:flex space-x-10">
            ...
            <a href="#" className="text-base font-medium text-gray-500 hover:text-indigo-600">
              Pricing
            </a>
            <a href="#" className="text-base font-medium text-gray-500 hover:text-indigo-600">
              Docs
